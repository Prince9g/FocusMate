  ...
  return (
    <div>
      <button
        ...
        className="bg-red-300 text-white px-4 py-2 mx-auto w-48 rounded-full mt-2 md:mt-6 hover:bg-transparent hover:text-black dark:text-white hover:border-2 hover:border-red-500 transition duration-300"
      >
        Create Room
      </button>
